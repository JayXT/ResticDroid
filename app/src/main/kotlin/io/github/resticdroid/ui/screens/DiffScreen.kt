...
fun DiffScreen(
    ...
    var body by remember(from, to) { mutableStateOf<String?>(null) }
    ...
    Scaffold(
        ...
        val text = body
        if (text == null) {
            // restic reads both snapshots' trees before it can say anything, so
            // this is a wait with nothing to show underneath it.
